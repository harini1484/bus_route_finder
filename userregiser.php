...
$rdate=date("d-m-Y");
	...
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from users where username='$username' && email='$email' ");
			$n1=mysqli_num_rows($q1);
				if($n1==0)
				{
                    $mq=mysqli_query($connect,"select max(id) from users");
                    $mr=mysqli_fetch_array($mq);
                    $id=$mr['max(id)']+1;
                    $ins=mysqli_query($connect,"insert into users(id,name,mobile,email,address,username,password,rdate) values($id,'$name','$mobile','$email','$address','$username','$password','$rdate')");
                    if($ins)
                    {
                ...
                <?php
                    ...
                    {
                        $msg="Username and email already used";
                    }
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">User</a></li>
    ...
    <div class="row">
      ...
      <form action="" name="form1" method="post">
		...
		<input type="password" class="form-control mb-3" name="password" placeholder="Password">
          ...
          <button type="submit" name="btn" value="send" class="btn btn-primary">Register</button>
        </form>
      </div>
      <div class="col-lg-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6 mb-5 mb-md-0">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mb-3"><a class="text-color" href="login_stu.php">User</a></li>
