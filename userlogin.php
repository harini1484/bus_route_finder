...
extract($_REQUEST);
	if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from users where username='$uname' && password='$pass' ");
    ...
    <div class="row">
      <div class="col-lg-7 mb-4 mb-lg-0">
        <form action="" name="form1" method="post">
          <input type="text" class="form-control mb-3" name="uname" placeholder="Username" required>
          <input type="password" class="form-control mb-3" name="pass" placeholder="Password" required>
          <button type="submit" name="btn" value="send" class="btn btn-primary">Login</button>
        </form>
		<span style="color:#FF0000"><?php echo $msg; ?></span>
    <a href="userregiser.php">Register</a>
      </div>  
      <div class="col-lg-5">
      </div>
    </div>
