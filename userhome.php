    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">User Information</a></li>
...
<section class="section bg-gray">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="section-title">LOCATION : FROM - TO</h2>
      </div>
    </div>
	<p>&nbsp;</p>
  <?php
    ...
    <div class="row">
      <div class="col-md-12">
	   ...
	   <td><?php echo $r1['duration'].'- Min/Hours'; ?></td>
	   <td><?php echo $r1['fare']; ?></td>
     <td><a href="#" onclick="openPopup(<?php echo $r1['id']; ?>)">STOP ALERT</a></td>	   
...
<div class="popup-overlay" id="popupOverlay">
    ...
    if(isset($set)){
      ...
      $ins=mysqli_query($connect,"insert into booking(id,busno,driver,user,seats,rdate,lat,lon) values($id,'$busno','$driver','$uname','$seats','$rdate','','')");
      if($ins)
      {
