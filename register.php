...
$ins=mysqli_query($connect,"insert into bus_route(id,busno,rname,dtpoint,dspoint,dist,duration,fare,rdate,lat,lon,driver) values($id,'$busno','$rname','$dtpoint','$dspoint','$dist','$duration','$fare','$rdate','$lat','$lon','')");
	if($ins)
	{
...
setTimeout(function () {
   ...
   window.location.href= 'adddriver.php?busno=<?php echo $busno;?>';
}, 3000);
</script>
<?php
	}
...
<section class="section bg-gray">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="section-title">Insert Bus Route</h2>
      </div>
    </div>
    <div class="row">
	  ...
	  ?>
		...
		<input type="text" class="form-control mb-3" name="busno" placeholder="Bus.No">
		<input type="text" class="form-control mb-3" name="rname" placeholder="Route Name">
		<input type="text" class="form-control mb-3" name="dtpoint" placeholder="Departure Point">
		<input type="text" class="form-control mb-3" name="dspoint" placeholder="Destination Point">
		<input type="text" class="form-control mb-3" name="dist" placeholder="Distance (in kilometers)">
		<input type="text" class="form-control mb-3" name="duration" placeholder="Duration (in hours)">
		<input type="hidden" class="form-control mb-3" id="lat" name="lat">
		<input type="hidden" class="form-control mb-3" id="lon" name="lon">
		<input type="text" class="form-control mb-3" name="fare" placeholder="Fare">
